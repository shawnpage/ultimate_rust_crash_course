...
fn volume(x: i32, y: i32, z: i32) -> i32 {
    // 3. Define a function here called `volume` that takes three arguments of type i32
    //    and returns the volume of a cuboid (a box) calculated using those dimensions.
    //
    x * y * z
}